...
public class Loop {
    ...
    public Loop withCondition(String condition) {
        this.condition = condition;
        return this;
    }
    ...
    public Loop withMaxIterations(Integer maxIterations) {
        this.maxIterations = maxIterations;
        return this;
    }
    ...
    public Loop withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
